...
namespace WarehouseClient.ServiceReference1 {
    ...
    public interface WarehouseWS {
        ...
        bool insertPallet(WarehouseClient.ServiceReference1.Pallet pallet);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [return: System.ServiceModel.MessageParameterAttribute(Name="insertPalletReturn")]
        System.Threading.Tasks.Task<bool> insertPalletAsync(WarehouseClient.ServiceReference1.Pallet pallet);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(Style=System.ServiceModel.OperationFormatStyle.Rpc, SupportFaults=true, Use=System.ServiceModel.OperationFormatUse.Encoded)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="retrievePalletsReturn")]
        WarehouseClient.ServiceReference1.Pallet[] retrievePallets(WarehouseClient.ServiceReference1.Good good, int count, int stationId);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [return: System.ServiceModel.MessageParameterAttribute(Name="retrievePalletsReturn")]
        System.Threading.Tasks.Task<WarehouseClient.ServiceReference1.Pallet[]> retrievePalletsAsync(WarehouseClient.ServiceReference1.Good good, int count, int stationId);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WarehouseWSChannel : WarehouseClient.ServiceReference1.WarehouseWS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WarehouseWSClient : System.ServiceModel.ClientBase<WarehouseClient.ServiceReference1.WarehouseWS>, WarehouseClient.ServiceReference1.WarehouseWS {
        ...
        public bool insertPallet(WarehouseClient.ServiceReference1.Pallet pallet) {
            return base.Channel.insertPallet(pallet);
        }
        
        public System.Threading.Tasks.Task<bool> insertPalletAsync(WarehouseClient.ServiceReference1.Pallet pallet) {
            return base.Channel.insertPalletAsync(pallet);
        }
        
        public WarehouseClient.ServiceReference1.Pallet[] retrievePallets(WarehouseClient.ServiceReference1.Good good, int count, int stationId) {
            return base.Channel.retrievePallets(good, count, stationId);
        }
        
        public System.Threading.Tasks.Task<WarehouseClient.ServiceReference1.Pallet[]> retrievePalletsAsync(WarehouseClient.ServiceReference1.Good good, int count, int stationId) {
